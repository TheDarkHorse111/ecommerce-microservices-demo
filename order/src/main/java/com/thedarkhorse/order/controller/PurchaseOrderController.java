...
public class PurchaseOrderController {
    ...
    @PostMapping
    public ResponseEntity<PurchaseOrder> addOrder(@RequestBody List<CartItem> cartItems) {
        return ResponseEntity.status(CREATED).body(service.createPurchaseOrder(cartItems));
    }
}
